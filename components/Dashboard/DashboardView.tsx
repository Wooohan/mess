...
const DashboardView: React.FC = () => {
  const stats = [
    { label: 'Open Chats', value: '24', icon: MessageSquare, color: 'text-blue-600', bg: 'bg-blue-50' },
    { label: 'Avg. Response Time', value: '4m 32s', icon: Clock, color: 'text-purple-600', bg: 'bg-purple-50' },
    { label: 'Resolved Today', value: '142', icon: CheckCircle2, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Customer Satisfaction', value: '98%', icon: Zap, color: 'text-amber-600', bg: 'bg-amber-50' },
  ];
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Here's what's happening across your Facebook Pages today.</p>
        </div>
        <div className="flex items-center gap-3">
           ...
           <button className="px-4 py-2 bg-blue-600 rounded-xl text-sm font-semibold text-white hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200">Manage Agents</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
          <div className="flex items-center justify-between mb-8">
             <h3 className="text-lg font-bold text-slate-800">Conversation Volume</h3>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-3xl text-white shadow-xl shadow-blue-200">
           <div className="flex flex-col h-full">
             ...
             <h3 className="text-xl font-bold mb-2">Flow AI Pro</h3>
             <p className="text-blue-100 text-sm mb-8 leading-relaxed">Upgrade your plan to unlock automated replies and full conversation sentiment analysis.</p>
             ...
             <div className="space-y-4 mt-auto">
                ...
                <div className="w-full bg-blue-900/40 h-2 rounded-full overflow-hidden">
                  <div className="bg-white h-full w-[78%] rounded-full shadow-sm" />
                </div>
